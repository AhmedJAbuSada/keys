...
public class PropertyFragment extends Fragment implements DoSearch, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void search(int limit) {
        query = FirebaseDatabase.getInstance().getReference().child("Ads").orderByChild("department").equalTo("العقارات").limitToLast(limit);
