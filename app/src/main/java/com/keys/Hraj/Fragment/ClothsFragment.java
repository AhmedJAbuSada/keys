...
public class ClothsFragment extends Fragment implements DoSearch, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void search(int limit) {
        query = FirebaseDatabase.getInstance().getReference().child("Ads").orderByChild("department")
                .equalTo("الملابس").limitToLast(limit);
