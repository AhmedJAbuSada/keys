...
public class FurnitureFragment extends Fragment implements DoSearch, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void search(int limit) {
        query = FirebaseDatabase.getInstance().getReference().child("Ads").orderByChild("department").equalTo("الآثاث").limitToLast(limit);
