 ...
 */
public class GridView_Adapter extends RecyclerView.Adapter<GridView_Adapter.GridViewHolder> {
    ...
    public GridViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(this.context).inflate(R.layout.row_multiphoto_item, parent, false);
