...
@EBean
public class GroupRecyclerViewAdapter extends RecyclerViewAdapterBase<Group, groupView> {
    ...
    @Override
    public void onBindViewHolder(ViewWrapper<groupView> holder, final int position) {
        final groupView view = holder.getView();
...
//        }
    ...
    @Override
    protected groupView onCreateItemView(ViewGroup parent, int viewType) {
        return groupView_.build(context);
//        groupView groupView = groupView_.build(context);
