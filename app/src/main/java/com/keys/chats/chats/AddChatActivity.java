...
import com.keys.chats.contacts.ContactsNonMemberRecyclerViewAdapter;
import com.keys.chats.contacts.ContactsRecyclerViewAdapter;
...
public class AddChatActivity extends AppCompatActivity {
    ...
    void afterView() {
        ...
        mLayoutManager = new LinearLayoutManager(AddChatActivity.this);
...
//                                String userQRCode = jUserData.optString("userQRCode");
    ...
    private ProgressDialog inintDialog() {
        pDialog = new ProgressDialog(AddChatActivity.this);
