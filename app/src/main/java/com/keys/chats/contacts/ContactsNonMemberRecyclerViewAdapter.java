...
@EBean
public class ContactsNonMemberRecyclerViewAdapter extends RecyclerViewAdapterBase<User, contactNonMemberView> implements Filterable {
    ...
    @Override
    public void onBindViewHolder(ViewWrapper<contactNonMemberView> holder, final int position) {
        final contactNonMemberView view = holder.getView();
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isCanChat())
                    ContactDetailsActivity_.intent(context).contactUser(s).start();
            }
        });
...
//        }
    ...
    @Override
    protected contactNonMemberView onCreateItemView(ViewGroup parent, int viewType) {
        return contactNonMemberView_.build(context);
